...
class TestNewsPage():
    ...
    def test_can_edit_news_page_heading(self, admin_browser):
        ...
        helper_functions.navigate_to_default_page_cms_section(admin_browser, 'News')
        helper_functions.edit_page_header(admin_browser, NEWS_INDEX_PAGE['title'], 'heading_en', NEWS_INDEX_PAGE['heading'])
    ...
    def test_can_edit_news_page_excerpt(self, admin_browser):
        ...
        helper_functions.edit_page_header(admin_browser, NEWS_INDEX_PAGE['title'], 'excerpt_en', NEWS_INDEX_PAGE['excerpt'])
...
class TestNewsIndexChildPages():
    ...
    def test_can_create_news_child_pages(self, admin_browser):
        ...
        helper_functions.create_news_child_page(admin_browser, NEWS_PAGE['page_type'], NEWS_PAGE['title'])
    ...
    def test_can_edit_news_child_page_heading(self, admin_browser):
        ...
        helper_functions.edit_page_header(admin_browser, NEWS_PAGE['title'], 'heading_en', NEWS_PAGE['heading'])
