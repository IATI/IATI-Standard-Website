    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('highlight', wagtail.fields.StreamField([('highlight', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(icon='title')), ('description', wagtail.blocks.CharBlock(icon='pilcrow')), ('page', wagtail.blocks.PageChooserBlock(icon='link')), ('link_label', wagtail.blocks.CharBlock(icon='link'))]))])),
                ('highlight_en', wagtail.fields.StreamField([('highlight', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(icon='title')), ('description', wagtail.blocks.CharBlock(icon='pilcrow')), ('page', wagtail.blocks.PageChooserBlock(icon='link')), ('link_label', wagtail.blocks.CharBlock(icon='link'))]))], null=True)),
                ('highlight_fr', wagtail.fields.StreamField([('highlight', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(icon='title')), ('description', wagtail.blocks.CharBlock(icon='pilcrow')), ('page', wagtail.blocks.PageChooserBlock(icon='link')), ('link_label', wagtail.blocks.CharBlock(icon='link'))]))], null=True)),
                ('highlight_es', wagtail.fields.StreamField([('highlight', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(icon='title')), ('description', wagtail.blocks.CharBlock(icon='pilcrow')), ('page', wagtail.blocks.PageChooserBlock(icon='link')), ('link_label', wagtail.blocks.CharBlock(icon='link'))]))], null=True)),
                ('highlight_pt', wagtail.fields.StreamField([('highlight', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(icon='title')), ('description', wagtail.blocks.CharBlock(icon='pilcrow')), ('page', wagtail.blocks.PageChooserBlock(icon='link')), ('link_label', wagtail.blocks.CharBlock(icon='link'))]))], null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', wagtail.fields.RichTextField(help_text='Description for the item')),
