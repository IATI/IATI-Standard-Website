# Generated by Django 2.2.9 on 2020-01-28 16:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('json_path', models.TextField(blank=True, help_text='Folder path of JSON object', null=True)),
                ('tag', models.CharField(help_text='Associated git release tag', max_length=255)),
                ('version', models.CharField(blank=True, help_text='IATI version', max_length=255, null=True)),
                ('language', models.CharField(blank=True, help_text='Language', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(help_text='Associated git release tag', max_length=255)),
                ('data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('data_en', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('data_fr', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('data_es', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('data_pt', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
