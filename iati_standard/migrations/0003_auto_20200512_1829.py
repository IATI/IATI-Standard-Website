...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=wagtail.fields.StreamField([('card', wagtail.blocks.StructBlock([('major_header', wagtail.blocks.CharBlock(help_text='Text for the header element of the card', required=False)), ('card_content', wagtail.blocks.StreamBlock([('minor_header', wagtail.blocks.CharBlock(icon='title', required=False, template='iati_standard/blocks/minor_header.html')), ('page_links', wagtail.blocks.StreamBlock([('page', wagtail.blocks.PageChooserBlock(required=False, template='iati_standard/blocks/page_link.html'))], template='iati_standard/blocks/page_links.html'))]))]))], blank=True, null=True),
        ),
        migrations.AddField(
            model_name='iatistandardpage',
