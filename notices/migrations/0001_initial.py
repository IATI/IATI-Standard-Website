# Generated by Django 2.2.9 on 2020-04-24 13:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice_type', models.CharField(choices=[('notice', 'Notice'), ('alert', 'Alert'), ('warning', 'Warning')], default='notice', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_es', wagtail.core.fields.RichTextField(help_text='Content for the notice', null=True)),
                ('content_pt', wagtail.core.fields.RichTextField(help_text='Content for the notice', null=True)),
                ('allow_dismiss', models.BooleanField(blank=True, default=False, help_text='Select to allow visitors to dismiss this message for two weeks')),
                ('display_type', models.CharField(choices=[('all', 'All pages'), ('selected_page', 'Selected page only,'), ('selected_page_and_children', 'Selected page and child pages'), ('children_only', 'Children of selected page')], default='selected_page', max_length=255)),
