    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', wagtail.fields.RichTextField(help_text='Content for the notice')),
                ('content_en', wagtail.fields.RichTextField(help_text='Content for the notice', null=True)),
                ('content_fr', wagtail.fields.RichTextField(help_text='Content for the notice', null=True)),
                ('content_es', wagtail.fields.RichTextField(help_text='Content for the notice', null=True)),
                ('content_pt', wagtail.fields.RichTextField(help_text='Content for the notice', null=True)),
            ],
            options={
                'abstract': False,
            },
