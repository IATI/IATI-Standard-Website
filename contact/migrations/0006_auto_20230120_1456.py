...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('contact', '0005_auto_20220804_1557'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='contact_type',
            field=wagtail.fields.StreamField([('contact_type_editor', wagtail.blocks.StructBlock([('heading', wagtail.blocks.TextBlock()), ('description', wagtail.blocks.RichTextBlock(required=False)), ('email', wagtail.blocks.TextBlock())], classname='title', icon='title'))], blank=True, null=True, use_json_field=True),
        ),
        migrations.AlterField(
            model_name='contactpage',
