    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_type', wagtail.fields.StreamField((('contact_type_editor', wagtail.blocks.StructBlock((('heading', wagtail.blocks.TextBlock()), ('description', wagtail.blocks.RichTextBlock(required=False)), ('email', wagtail.blocks.TextBlock())), classname='title', icon='title')),), blank=True, null=True)),
                ('contact_type_en', wagtail.fields.StreamField((('contact_type_editor', wagtail.blocks.StructBlock((('heading', wagtail.blocks.TextBlock()), ('description', wagtail.blocks.RichTextBlock(required=False)), ('email', wagtail.blocks.TextBlock())), classname='title', icon='title')),), blank=True, null=True)),
                ('contact_type_fr', wagtail.fields.StreamField((('contact_type_editor', wagtail.blocks.StructBlock((('heading', wagtail.blocks.TextBlock()), ('description', wagtail.blocks.RichTextBlock(required=False)), ('email', wagtail.blocks.TextBlock())), classname='title', icon='title')),), blank=True, null=True)),
                ('contact_type_es', wagtail.fields.StreamField((('contact_type_editor', wagtail.blocks.StructBlock((('heading', wagtail.blocks.TextBlock()), ('description', wagtail.blocks.RichTextBlock(required=False)), ('email', wagtail.blocks.TextBlock())), classname='title', icon='title')),), blank=True, null=True)),
                ('contact_type_pt', wagtail.fields.StreamField((('contact_type_editor', wagtail.blocks.StructBlock((('heading', wagtail.blocks.TextBlock()), ('description', wagtail.blocks.RichTextBlock(required=False)), ('email', wagtail.blocks.TextBlock())), classname='title', icon='title')),), blank=True, null=True)),
            ],
            options={
                'abstract': False,
            },
